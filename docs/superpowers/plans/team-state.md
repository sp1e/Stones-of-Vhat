...
| Playable Three view/input/menu | playable_courtyard (gpt-5.6-sol/high) | Implemented 6d92691; fixing independently reproduced BFCache restoration defect with a real full-Chromium regression |
| Integrated browser QA and visual checks | Coordinator, browser_spec (gpt-5.6-terra/high), browser_quality (gpt-6-astra/high) | Spec PASS; quality independently passed 31 native + 4 browser tests but found one P2 navigation lifecycle issue; focused recheck required |
