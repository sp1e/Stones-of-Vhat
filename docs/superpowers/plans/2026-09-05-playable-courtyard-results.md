...
- `rtk npm --prefix game run test:browser`: 4/4 Chromium tests passed in 26.3 seconds.
...
- The production JavaScript chunk is 3,390.45 kB minified / 1,231.67 kB gzip because the approved Rapier compatibility package ships its runtime payload in the browser bundle. Vite emits its standard >500 kB advisory; this does not fail the build but is a future load-time optimization target.
